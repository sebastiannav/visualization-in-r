...
A confusion matrix is used to evaluate the model. The matrix shows when the model gives true/false positives and true/false negatives. Depending on the business case, different measures can be used to 

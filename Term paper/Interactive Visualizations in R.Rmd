...
To illustrate how interactive visualizations can make it easier to dig deeper into the data, we have used the Ames Housing dataset downloaded from the American Statistical Association. The dataset includes data on properties sold in Ames, Iowa.
...
ggplot(data = house, aes_string(x = house$GrLivArea, y = house$SalePrice)) +
  ...
  labs(x = "Living area (square feet)", y = "Sale Price ($)", col = "Neighborhood")
```

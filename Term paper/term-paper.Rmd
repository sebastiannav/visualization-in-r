...
@book{wickham2016ggplot2,
  ...
  year={2016},
  publisher={Springer},
  howpublished = "\url{https://books.google.no/books?hl=en&lr=&id=XgFkDAAAQBAJ&oi=fnd&pg=PR8&dq=ggplot2&ots=so_5bO526U&sig=IGjCMZpZsa-7gLeFD_igZRi3gJU&redir_esc=y#v=onepage&q=ggplot2&f=false}",
}
...
@book{beeley2016web,
  ...
  howpublished = "\url{https://books.google.no/books?hl=en&lr=&id=FW0dDAAAQBAJ&oi=fnd&pg=PP1&dq=shiny+create+dashboard+r&ots=kE6he7qqAV&sig=JS2heDVo9FmEd71rXxAJctOSbqc&redir_esc=y#v=onepage&q=shiny%20create%20dashboard%20r&f=false 
}"
}
